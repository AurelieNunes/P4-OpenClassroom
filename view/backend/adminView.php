...
<section id="adminPanel">
	...
	<div class="headPost text-center">
		...
		<section id="updatepost">
			...
			<p class="mb-2"><?= $post['date_fr']; ?></p>

			<?php if ($post['date_fr'] < $post['update_date_fr']) {
						echo '<p>modifié le ' . $post['update_date_fr'] . '</p>';
					} ?>
			<?php
								} else {
			...
			<div class="modal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Voulez-vous vraiment supprimer le commentaire de <?= $report['author']; ?></p>
						</div>
						<div class="modal-footer">
			...
			<div class="modal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Voulez-vous vraiment supprimer le membre <?= $member['pseudo']; ?></p>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"> <a class="text-white"
